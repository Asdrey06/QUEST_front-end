  ...
  return (
    ...
    >
      <div className="bg-[9C339C] mb-10 ">
        ...
        <div className="bg-white p-8 rounded-md shadow-lg max-w-4xl mx-auto justify-center">
          ...
          <p className="mb-3">
            ...
            directement. Lorsque vous interagissez avec notre site, nous pouvons
            collecter des informations telles que votre nom, votre adresse
            e-mail, votre adresse postale, etc.
          </p>
          ...
          <p className="mb-3">
            ...
            rectification, de suppression, d'opposition, etc. Pour toute demande
            relative à vos données, vous pouvez contacter notre service dédié.
          </p>
          ...
          <p className="mb-3">
            ...
            apportons des modifications, nous vous en informerons afin que vous
            puissiez revoir et, si nécessaire, vous opposer à ces modifications.
          </p>
        </div>
      </div>
    </div>
